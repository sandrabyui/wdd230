...
const apiURL = "//api.openweathermap.org/data/2.5/weather?q=california&units=imperial&appid=1fd67ce3b98242ba1f7c1c14796ab216";
...
fetch(apiURL)
    ...
    .then((jsObject) => {
        ...
        document.querySelector("#tempname").textContent = name;
